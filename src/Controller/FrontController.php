...
class FrontController extends AbstractController
{
    ...
    // cette fonction affiche la page d'accueil, d'où sa route confirgurée sur "/".
    // Toutes fonctions possédent un return qui necessite une route en paramètre (gérée en annotation\Route)
    // ainsi q"un name qui permettra d'appeler cette fonction dans notre twig
    /**
     * @Route ("/",name="home")
     */
    public function home(ArticleRepository $articleRepository,CategorieRepository $categorieRepository,PanierService $panierService, PaginatorInterface $paginator, Request $request)// on injecte la dependance ArticleRepository afin de pouvoir utiliser les methodes presente dans la class ArticleRepository
    {
